    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/moderator/**","/api/user/**").hasAnyRole("MODERATOR", "SUPER_ADMIN") // Moderator and super admin
                        .requestMatchers("/api/posts/**").hasAnyRole("USER", "MODERATOR", "SUPER_ADMIN") // User actions
